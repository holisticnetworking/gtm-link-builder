<?php
namespace Gtm_Link_Builder\Frontend;
 ...
 *
 * @package    Gtm_Link_Builder
 * @subpackage Gtm_Link_Builder/Frontend
...
class Gtm_Link_Builder_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Gtm_Link_Builder_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Gtm_Link_Builder_Loader will then create the relationship
